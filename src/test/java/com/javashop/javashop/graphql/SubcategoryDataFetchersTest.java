...
@EnableWebMvc
class SubcategoryDataFetchersTest {

    @Autowired
    private SubcategoryDataFetchers subcategoryDataFetchers;
    ...
    public void contextLoads() throws Exception {
        assertThat(subcategoryDataFetchers).isNotNull();
    }

    @Test
    public void getOrders() throws Exception {
        ClassLoader classloader = Thread.currentThread().getContextClassLoader();
        InputStream is = classloader.getResourceAsStream("getSubcategory.graphql");
